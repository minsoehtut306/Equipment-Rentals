...
namespace INTRO_USERS
{
    class SQL
    {
        ...
        public static SqlConnection con = new SqlConnection(@"Data Source=cairo.cms.waikato.ac.nz;Database=mh1155_Deliverable_2;Integrated Security=True");
        public static SqlCommand cmd = new SqlCommand();
        public static SqlDataReader read;

        /// <summary>
        /// This executes the query, used mainly for 
        ...
        {
            //try catch to catch any unforeseen errors gracefully
            try
            {
                con.Close();
                cmd.Connection = con;
            ...
            {
                //put a message box in here if you are receiving errors and see if you can find out why?
        ...
        /// <summary>
        /// Prints out the ID based on the query given into a combo box
        /// </summary>
